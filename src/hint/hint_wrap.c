...
#define SWIG_init    init_hint

#define SWIG_name    "_hint"
...
static PyObject *_wrap_bestmove(PyObject *self, PyObject *args) {
    ...
    self = self;
    if(!PyArg_ParseTuple(args,"ii:bestmove",&_arg0,&_arg1)) 
        return NULL;
    bestmove(_arg0,_arg1);
    Py_INCREF(Py_None);
    _resultobj = Py_None;
    return _resultobj;
}
...
static PyObject *_wrap_getbestmovecolumns(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,":getbestmovecolumns")) 
        return NULL;
    _result = (int )getbestmovecolumns();
    _resultobj = Py_BuildValue("i",_result);
    return _resultobj;
}
...
static PyObject *_wrap_findlevel(PyObject *self, PyObject *args) {
    ...
    self = self;
    if(!PyArg_ParseTuple(args,"ii:findlevel",&_arg0,&_arg1)) 
        return NULL;
    findlevel(_arg0,_arg1);
    Py_INCREF(Py_None);
    _resultobj = Py_None;
    return _resultobj;
}
...
static PyObject *_wrap_getpackedcolumns(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,":getpackedcolumns")) 
        return NULL;
    _result = (int )getpackedcolumns();
    _resultobj = Py_BuildValue("i",_result);
    return _resultobj;
}

static PyMethodDef _hintMethods[] = {
	 { "getpackedcolumns", _wrap_getpackedcolumns, 1 },
	 { "getpackedrows", _wrap_getpackedrows, 1 },
	 { "getbestyoucando", _wrap_getbestyoucando, 1 },
	 { "findlevel", _wrap_findlevel, 1 },
	 { "getbestmovecolumns", _wrap_getbestmovecolumns, 1 },
	 { "getbestmoverows", _wrap_getbestmoverows, 1 },
	 { "init", _wrap_init, 1 },
	 { "bestmove", _wrap_bestmove, 1 },
	 { NULL, NULL }
};
...
extern "C" 
#endif
SWIGEXPORT(void,init_hint)() {
	 PyObject *m, *d;
	 SWIG_globals = SWIG_newvarlink();
	 m = Py_InitModule("_hint", _hintMethods);
